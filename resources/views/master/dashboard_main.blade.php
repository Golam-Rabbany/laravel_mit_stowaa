            ...
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                        <span class="user-img">
							<img class="rounded-circle" src="{{asset('dashboard/img/user.jpg')}}" width="24" alt="Admin">
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
							<a href="#"><i class="fa fa-user"></i> <span>Sub Category </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
								<li><a href="{{route('subcategory.create')}}">Sub Category Create</a></li>
								<li><a href="{{route('subcategory.index')}}">Show Sub Category</a></li>
                        ...
                        <li class="submenu">
							...
							<ul style="display: none;">
								...
								<li><a href="{{route('product.index')}}">Show Product List</a></li>
